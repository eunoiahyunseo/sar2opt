...
class RAM(nn.Module):
    ...
    def condition_forward(self,
        ...
        swin_output, hierarchical_features = self.visual_encoder(image, return_inter_feature=True)
        image_embeds = self.image_proj(swin_output)
        ...
        if only_feature:
            ...
            return image_embeds, logits, targets, hierarchical_features
